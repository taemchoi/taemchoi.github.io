...
- [Model Architecture](#3-model-architecture)
  - [Encoder and Decoder Stacks](#1-encoder-and-Decoder-Stacks)
  - [Attention](#2-attention)
  - [Postion-wise Feed-Forward Networks](#3-postion-wise-feed-forward-networks)
  - [Embedding and Softmax](#4-embedding-and-softmax)
  - [Positional Encoding](#5-positional-encoding)
